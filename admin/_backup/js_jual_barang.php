                ...
                switch ($_GET[act]) { // ============================================================================================================
                    case "caricustomer": // ========================================================================================================
                        ...
                        if ($transferahad) {
                            ...
                            $sql = "SELECT username FROM user WHERE user_id = '{$_SESSION['idCustomer']}'";
                            ...
                            ?>
                            <div class="top">
                             <table width="690" border="0" cellspacing="2">
  <tr>
    <td width="60">username :</td>
    <td width="77"><?php echo $_SESSION['username']; ?></td>
    <td width="10">&nbsp;</td>
    <td width="56">NAMA :</td>
    <td width="104"> <?php echo $_SESSION['namaCustomer']; ?></td>
    <td width="24">&nbsp;</td>
    <td width="50">alamat :</td>
    <td width="257"> <?php echo $_SESSION['alamat'] ;   ?>, <?php echo $_SESSION['kota'] ;   ?></td>
  </tr>
</table>   
                                <?php
                        ...
                        $sql = "SELECT *
                                FROM tmp_detail_jual tdj, barang b LEFT JOIN nm_brg as n ON b.nm_id = n.nm_id
                        ...
                        if ($r) {
                            ...
                            <table class="tabel daftar-pembelian">
                                ...
                                $query2 = mysql_query("SELECT tdj.uid, tdj.barcode, b.nm_id, n.nm_brg, tdj.jumBarang, b.harga hargaNormal, tdj.harga, tdj.tglTransaksi, tdj.diskon_persen, tdj.diskon_rupiah
                                        FROM tmp_detail_jual tdj, barang b LEFT JOIN nm_brg as n ON b.nm_id=n.nm_id
                                ...
                                while ($data = mysql_fetch_array($query2)) {
                                    ...
                                    $total = $data['harga'] * $data['jumBarang'];
                                    $totalDiskon = 0;
                                    ?>
                                    ...
                                    <tr class="<?php echo $no % 2 === 0 ? 'alt' : ''; ?>">
                                        ...
                                        <td class="right">
                                            ...
                                            if ($_SESSION['hakAdmin']) {
                                                ?>
                                                <a href="#" class="harga-jual pilih" data-type="text" data-pk="<?php echo $data['uid']; ?>" data-url="./aksi.php?module=diskon&act=updatehj" ><?php echo $data['harga']; ?></a>
                                                <?php
                                            } else {
                                                echo $data['harga'];
                                            }
