...
$carimerk = mysql_query("SELECT merk_id FROM merk where `nama` = '$data[4]' ");
    ...
    echo "<br><strong>Import data selesai.</strong>";
      ...
      <div class="desc">
        <p>Silahkan masukan file csv yang ingin diupload dengan contoh seperti <a href="contohcsv/qwe.csv">ini</a></p> <br /> 
      </div>
     <form enctype='multipart/form-data' action='csv.php' method='post'>
    Cari CSV File anda:<br />
    <input type='file' name='filename' size='100'>
   <div class="submit-gambar"><button  type="submit" class="btn tombol-gambar">TAMBAHKAN</button></div>
</div></form>
    </div> 
