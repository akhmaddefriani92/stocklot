                ...
                <div class="leftpanel">
                    ...
                    <ul class="nav nav-pills nav-stacked">
                        ...
                        <li class="parent"><a href=""><i class="fa fa-suitcase"></i><span>Order</span></a>
                            <ul class="children">
                                <li><a href="home.php?page=order">Order Masuk</a></li>
                                <li><a href="home.php?page=kirim">Order Dikonfirmasi</a></li>
                               	
                            </ul>
                        </li>
                        <li class="parent"><a href=""><i class="fa fa-suitcase"></i><span>Pengguna</span></a>
                            <ul class="children">
                                <li><a href="home.php?page=admin">Admin</a></li>
                                <li><a href="home.php?page=customer">User</a></li>
                            </ul>
                        </li>                         
                        </li>
                        <li class="activete"><a href="home.php?page=konfirmasi"><i class="fa fa-suitcase"></i> <span>Notifikasi</span></a></li>
                        <li class="parent"><a href=""><i class="fa fa-suitcase"></i><span>Kasir</span></a>
                            <ul class="children">
                                <li><a href="home.php?page=jualanbarang">Penjualan Barang</a></li>
