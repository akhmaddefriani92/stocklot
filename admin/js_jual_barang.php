...
<style>
    ...
    hr.hr1 { overflow: visible; /* For IE */ padding: 0; border: none; border-top: medium double #333; color: #333; text-align: center; } 
    hr.hr1:after { content: "§"; display: inline-block; position: relative; top: -0.7em; font-size: 1.5em; padding: 0 0.25em; background: white; }
</style>
<div class="mainpanel">
                    ...
                    case "caricustomer": // ========================================================================================================
                        ...
                        if ($_GET[doit] == 'hapus') {
                            if ($_SESSION['hakAdmin'] || $transferahad) {
                                ...
                                $sql = "DELETE FROM tmp_detail_jual WHERE barcode = '{$r['barcode']}' and idCustomer='{$_SESSION['idCustomer']}'";
                        ...
                        ?>
                        <div style="float:right;color:#000;" id="tot_pembelian">
                        ...
                        if ($transferahad) {
                            ...
                            ?>
                            <div class="top">
                            <table width="531" height="81" border="0" cellspacing="2" style="color:#000;">
                                  <tr>
                                    <td width="50" align="center">Nama</td>
                                    <td width="32" align="center">:</td>
                                    <td width="313" ><?php echo $_SESSION[namaCustomer];?></td>
                                  </tr>
                                  <tr>
                                    <td align="center">alamat</td>
                                    <td align="center">:</td>
                                    <td ><?php echo " {$_SESSION['alamat']},{$_SESSION['kota']}";?></td>
                                  </tr>
                                  <tr>
                        ...
                        ?>
                        <form id="entry-barang" method=POST action='js_jual_barang.php?act=caricustomer&action=tambah' class="form-inline">
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <div class="input-group" style="width: 220px;">
                                        <span class="input-group-addon">Barcode</span>
                                        <input type="text" name="barcode" accesskey="b" id="barcode" autofocus autocomplete="off" class="form-control " >
                                    </div>
                                </div>
                            ...
                            if ($ukmMode) {
                                ...
                                <div class="form-group">
                                    <div class="input-group" style="width: 120px;">
                                        ...
                                        <input type="text" id="hargaBarang" name='hargaBarang' value='1' size=5 accesskey="h" autocomplete="off" class="form-control ">
                                    </div>
                                </div>
                            ...
                            ?>
                                <div class="form-group">
                                    <div class="input-group" style="width: 120px;">
                                        ...
                                        <input type="text" id="jumBarang" name='jumBarang' value='1' size=5 accesskey="q" autocomplete="off" class="form-control ">
                                    </div>
                                </div>
                        ...
                        <!--<input type="submit" name="btnTambah" value="Tambah" accesskey="t">-->
                            <div class="form-group">
                            <!-- <button type="submit" ><span class="u">T</span>Tambah</button> -->
                             <button type="submit" style="margin:0px;padding:5px;" class="btn btn-primary btn-lg">Tambah</button>
                            </div>
                          
                            </form>
                        </div>
                        <form method="POST" action="js_cari_barang.php?caller=js_jual_barang" onSubmit="popupform(this, 'cari1')" class="form-inline">
                        <div class="col-md-3">
                            <div class="form-group">
                                    <div class="input-group" style="width: 220px;">
                                        <span class="input-group-addon">Cari Barang</span>
                                        <input type="text" id="namaBarang" name='namabarang' accesskey='c' class="form-control ">
                        ...
                        $sql = "SELECT *
                                FROM tmp_detail_jual tdj, barang b LEFT JOIN size as s ON b.size_id=s.size_id
                        ...
                        if ($r) {
                            ...
                            <table class="tabel daftar-pembelian" >
                                ...
                                $query2 = mysql_query("SELECT tdj.uid, tdj.barcode, b.nm_brg, b.size_id, s.size, tdj.jumBarang, b.harga hargaNormal, tdj.harga, tdj.tglTransaksi, tdj.diskon_persen, tdj.diskon_rupiah
                                        FROM tmp_detail_jual tdj, barang b LEFT JOIN size as s ON b.size_id=s.size_id
										WHERE tdj.barcode = b.barcode AND tdj.idCustomer = '{$_SESSION['idCustomer']}'
										AND tdj.username = '{$_SESSION['uname']}' ORDER BY tdj.uid DESC") or die (mysql_error());
                                ...
                                while ($data = mysql_fetch_array($query2)) {
                                    ...
                                    if (($_POST['transferahad'] == 1) || ($_GET['transferahad'] == 1)) {
                                        ...
                                        $data['harga'] = $x['hargaBeli'];
                                    };

                                    $total = ($data['harga'] - $_SESSION['diskonkhusus'] -  $_SESSION['customerDiskonR'] - ($_SESSION['customerDiskonP']/100 * $data['harga']))* $data['jumBarang'];
                                    $totalDiskon = 0;
                                    ?>
                                    ...
                                    <tr class="<?php echo $no % 2 === 0 ? 'alt' : ''; ?>">
                                        ...
                                        <td class="right">
                                            ...
                                            if ($_SESSION['hakAdmin']) {
                                                ?><form method=POST enctype="multipart/form-data" action="./aksi.php?module=diskon&act=diskonk">
                                                <input type=hidden name='userid' value="<?php echo $_SESSION[idCustomer]; ?>" >
                                                <input style=”width:500px;” type="text" id="diskonk" name="diskonk" placeholder="Nama User Admin" value="<?php echo number_format($_SESSION['diskonkhusus'],0, ',', '.'); ?>" />
                                                </form>
                                                <?php
                                            } else {
                                                 echo number_format($_SESSION['diskonkhusus'],0, ',', '.');
                                            }
                                            ?>
                                        </td>
                                         <td class="right"><?php echo number_format($_SESSION['customerDiskonR'], 0, ',', '.'); ?></td> 
                                         <td class="right"><?php echo $_SESSION['customerDiskonP'] . '%'; ?></td> 
                                        <td class="right">
                                            <?php
                                            // Jika punya hak admin, maka muncul link untuk manually update harga jual
                                            // Jika tidak, maka hanya muncul text statis harga jual
                                            
                                                echo $data['harga'] - $_SESSION['diskonkhusus'] - $_SESSION['customerDiskonR'] - ($_SESSION['customerDiskonP']/100 * $data['harga']);
...
//								}
                        ...
                        <div class="col-md-4">
                            ...
                            <form method=POST action='aksi.php?module=penjualan_barang&act=input'>
                                ...
                                <div class="kasir-kanan">
                                    <div id='kembalian' style="color:#000;"></div>
                                    <div class="pembayaran" style="margin-left: 20px;margin-right: 0px;right: 0;">
                                        <table class="pembayaran" style="text-align: left;width:100; font-size: 12px;color:#000;"   >
                                            <tr>
                                            ...
                                            ?>
                                            <tr>
                                                <td><a href='./aksi.php?module=penjualan_barang&act=batal<?php echo $transferahad ? '&transferahad=1' : ''; ?>' class="btn btn-danger btn-sm">Batal</a></td>
                                                <td class="right" colspan="2">&nbsp;&nbsp;&nbsp;<input type=submit value='Simpan' onclick='this.form.submit();this.disabled = true;'></td>
                                            </tr>
                                        </table>
                                    </div>
                                </div>
                        ...
                        <div class="logo-kasir">
                            ...
                            <img src="../img/logo-dark.png" width="50%" style="margin-left: 20px;">
                        </div>
                        <?php
                        break;
                    case 'carisupplier':
            ...
            <div id="input user" style="
                ...
                <form>
                    ...
                    <input type="password" id="password" name="password" placeholder="Password" /><br />
                    <a href="js_jual_barang.php?act=caricustomer<?php echo $transferahad ? '&transferahad=1' : ''; ?>" class="tombol" id="tombol-batal-login" accesskey="l">Bata<u>l</u></a>
                    <input style="float: right" type="submit" id="caricustomer" value="Submit" />
                </form>
            </div>
            ...
            <div id="self-checkout" style="
                ...
                <form id="form-sc">
                    ...
                    <input type="text" id="nm_depan" name="nm_depan" placeholder="nama depan" autocomplete="off"/><br />
                    <input type="text" id="nm_belakang" name="nm_belakang" placeholder="nama belakang" autocomplete="off"/><br />
                    <input type="text" id="alamat" name="alamat" placeholder="alamat" autocomplete="off"/><br />
                    <input type="text" id="kecamatan" name="kecamatan" placeholder="kecamatan" autocomplete="off"/><br />
                    <input type="text" id="kota" name="kota" placeholder="kota" autocomplete="off"/><br />
                    <input type="text" id="provinsi" name="provinsi" placeholder="provinsi" autocomplete="off"/><br />
                    <input type="text" id="kd_pos" name="kd_pos" placeholder="kode pos" autocomplete="off"/><br />
                    <input type="text" id="noHP" name="noHP" placeholder="noHP" autocomplete="off"/><br />
                    <!--<input type="password" id="password" name="password" placeholder="Password" /><br />-->
                    <!--<a href="js_jual_barang.php?act=caricustomer" class="tombol" id="tombol-batal-sc" accesskey="l">Bata<u>l</u></a>-->
                    <input style="float: right" type="submit" id="tombol-tambahuser-submit" value="Submit" />
                </form>
            </div>
            <div id="ganti-customer" style="
                 ...
                 <form id="form-nomor-kartu">
                    <input type="text" id="uname" name="uname" placeholder="Nomor Kartu" autocomplete="off"/><br />
                    <input style="float: right" type="submit" id="tombol-cariuser-submit" value="Submit" />
                </form>
            </div>
            ...
            <div id="footer" class="hide-for-print"  style="background:#CCC; ">
                <div class="href" style="float: left;">
                <?php
                if ($returBeli) {
                 ?>	
                    <a class="btn btn-success " href="js_jual_barang.php?act=carisupplier" accesskey="r" ><b><u>R</u></b>eload</a>
                    <?php
                } else {
                    ?>
                    <a class="btn btn-success " href="js_jual_barang.php?act=caricustomer<?php echo $transferahad ? '&transferahad=1' : ''; ?>" accesskey="r" ><b><u>R</u></b>eload</a>
                    <a class="btn btn-success <?php echo $hapusGagal || $batalGagal ? " getar" : ''; ?>" href="" accesskey="d" id="admin-mode" <?php
                     echo $_SESSION['hakAdmin'] ? 'style="background-color:#a8cf45;color:#fff"' : ''; ?>>
                    <?php echo $_SESSION['hakAdmin'] ? '<i class="fa fa-power-off" style="color:green;"></i>' : '<i class="fa fa-power-off" ></i>'; ?> A<u><b>d</b></u>min Mode
                    </a>
                    <a class="btn btn-success " href="#" id="tombol-self-checkout" accesskey="f" >Tam<b><u>bah</u></b> pelanggan</a>
                    <a class="btn btn-success " href="#" id="tombol-nomor-kartu" accesskey="k" ><b><u>input</u></b>pelanggan</a>
                    <a class="btn btn-success " href="#" id="tombol-cek-harga" accesskey="g" >Cek Har<b><u>g</u></b>a</a>
                <?php
                 }
                ?>
                </div>
            ...
            <script>
                ...
                $("#form-nomor-kartu").submit(function () {
                    ...
                    dataurl = "./aksi.php?module=diskon&act=cariuser";
                    $.ajax({
                        type: "POST",
                        url: dataurl,
                        data: datakirim,
                ...
                $("#form-sc").submit(function () {
                    ...
                    var datakirim = {
                        ...
                        'nm_depan': $("#nm_depan").val(),
                        'nm_belakang': $("#nm_belakang").val(),
                        'alamat': $("#alamat").val(),
                    ...
                    dataurl = "./aksi.php?module=penjualan_barang&act=inputmember";
                    $.ajax({
                        type: "POST",
                        url: dataurl,
                        data: datakirim,
...
?>
                ...
                $("#tombol-login-submit").click(function () {
                 ...
                 $("#tombol-cariuser-submit").click(function () {
                    var datakirims = {
                        'uname': $("#uname").val(),
                    }
                    console.log(datakirims);
                    dataurls = "./aksi.php?module=diskon&act=cariuser";
                    $.ajax({
                        type: "POST",
                        url: dataurls,
                        data: datakirims,
                        success: function (data) {
                            if (data === 'ketemu') {
                                ...
                                alert('Login ditolakaa!');
                            }
                        },
                    });
                    return false;
                });
                 $("#tombol-tambahuser-submit").click(function () {
                    var datakirim = {
                        'username': $("#username").val(),
                        'nm_depan': $("#nm_depan").val(),
                        'nm_belakang': $("#nm_belakang").val(),
