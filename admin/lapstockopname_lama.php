...
<div class="row">
                         ...
                         <?php include "config.php";
                               ...
                               if (empty($_GET)) { $sql = "SELECT barang.kd_brg, barang.barcode, barang.nm_brg,barang.size_id,size.size,warna.warna,merk.nama,detail_beli.hargaBeli, barang.qty,fast_stock_opname.jmlTercatat,fast_stock_opname.selisih,fast_stock_opname.tanggalSO FROM barang 
                                ...
                                LEFT JOIN detail_beli ON barang.barang_id = detail_beli.barang_id order BY fast_stock_opname.tanggalSO desc";
