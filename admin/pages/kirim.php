...
<thead>
           ...
           $tampil = mysql_query("SELECT * FROM `order`
				ORDER BY `order_id` ASC LIMIT $mulai,1000")or die(mysql_error());
            ...
            <tbody>
                ...
                while (($r = mysql_fetch_array($tampil)) or ( $ctr < 1000)) {
                    ...
                    ?>
                        <?php 
						$tampil4 = mysql_query("SELECT * FROM notifikasi where order_id = '".$r['order_id']."'");
						$u = mysql_fetch_array($tampil4);
						?>
                        <?php 
						$tampil4 = mysql_query("SELECT * FROM user inner join level on level.level_id = user.level_id where user_id = '".$u['user_id']."'");
						$s = mysql_fetch_array($tampil4);
						?>
                    <tr class="<?php echo $no % 2 === 0 ? 'alt' : ''; ?>">
                        ...
                        <td><?php echo $s['alamat'];?>&nbsp;<?php echo $s['kecamatan'];?>&nbsp;<?php echo $s['kota'];?>&nbsp;<?php echo $s['provinsi'];?></td>
                        <td><?php echo $s['hp'];?></td>
                        <td><?php echo $u['nominal'];?></td>
                      <td class="right"><?php echo $u['tgl_kirim']; ?></td>
                                              <?php 
						$tampil5 = mysql_query("SELECT * FROM status where status_id = '".$r['status_id']."'");
