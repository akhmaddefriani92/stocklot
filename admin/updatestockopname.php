...
<div class="row">
                         ...
                         <?php include "config.php";
                               ...
                               if (empty($_GET)) { $sql = "SELECT barang.kd_brg, barang.barcode, barang.nm_brg,barang.size_id,size.size,warna.warna,merk.nama,detail_beli.hargaBeli, barang.qty,fast_stock_opname.jmlTercatat,fast_stock_opname.selisih FROM barang 
                                ...
                                LEFT JOIN fast_stock_opname ON barang.barang_id = fast_stock_opname.barang_id AND fast_stock_opname.tanggalSO = '$tanggal' and approved = 0
