                        ...
                        <div class="col-md-8 col-md-offset-2">
                            ...
                            ?>
                                        ...
                                        <form class="customer-details mb-xs-40" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" method="post" id="form-user">
                                            ...
                                            <div class="input-with-label col-sm-6 text-left">
                                                <span>Kota:</span>
                                                <input type="text" name="kota" value="<?php echo "$kota"; ?>" pattern="[A-Za-z-_\.\s]{2,50}" required />
                                            </div>
                                            <div class="input-with-label col-sm-6 text-left">
                                                <span>Provinsi:</span>
                                                <input type="text" name="prov" value="<?php echo "$provinsi"; ?>" pattern="[A-Za-z-_\.\s]{2,50}" required />
                                            </div>
                            ...
                            ?>
                                        ...
                                        <form class="customer-details mb-xs-40" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" method="post" id="form-user">
                                            ...
                                            <div class="input-with-label col-sm-6 text-left">
                                                <span>Kota:</span>
                                                <input type="text" name="kota" pattern="[A-Za-z-_\.\s]{2,50}" required />
                                            </div>
                                            <div class="input-with-label col-sm-6 text-left">
                                                <span>Provinsi:</span>
                                                <input type="text" name="prov" pattern="[A-Za-z-_\.\s]{2,50}" required />
                                            </div>
                                            <div class="col-sm-4 col-sm-offset-4">
                                                <input type="submit" form="form-user" class="" value="Confirm Edit" name="confirmedit" />
                                            </div>
