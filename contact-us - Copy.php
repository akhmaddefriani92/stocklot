                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6 col-md-5 col-md-offset-1">
                            <form class="form-email" data-success="Thanks for your submission, we will be in touch shortly." data-error="Please fill all fields correctly.">
                                ...
                                <input type="text" class="validate-required" name="jumlah"  placeholder="Message"></input>
                                <select class="validate-required" name="bank"> <option>pilih bank</option>
                           ...
                           echo "<option value='$entry[nama]'>$entry[nama]</option>";
                                ...
                                <input class="validate-required" name="jumlah"  placeholder="Message"></input>
